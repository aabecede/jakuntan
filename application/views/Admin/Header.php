    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="<?php echo base_url('assets/');?>images/jakuntan-logo.png" alt="Logo"></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="<?php echo base_url('admin/home');?>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    <h3 class="menu-title">UI Data</h3><!-- /.menu-title -->
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="<?php echo base_url('admin/datamember');?>?>">Data Member</a></li>
                            <li><i class="fa fa-table"></i><a href="<?php echo base_url('admin/dataakuntan');?>">Data Akuntan</a></li>
                            <li><i class="fa fa-table"></i><a href="<?php echo base_url('admin/datatransaksi');?>">Data Transaksi</a></li>
                        </ul>
                    </li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/admin.jpg" alt="<?php echo $nama;?>">
                        </a>
