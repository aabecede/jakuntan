...
--
-- Host: localhost:3306
-- Waktu pembuatan: 31 Jul 2018 pada 05.49
...
INSERT INTO `data_diri` (`id`, `id_login`, `jk`, `id_prov`, `id_kab`, `alamat`, `foto`, `aboutme`) VALUES
(1, 1, 1, 16, 1671, '123', '11523328393.jpg', 'akuuuu'),
(2, 2, 2, 12, 1201, 'Jl. Kesini', '21523344454.jpg', 'Sayang Sekali\r\n'),
(3, 3, 0, 0, 0, '', '', ''),
(4, 4, 0, 0, 0, '', '', ''),
(5, 5, 0, 0, 0, '', '', ''),
(6, 6, 0, 0, 0, '', '', ''),
...
INSERT INTO `identitas` (`id_login`, `npwp`, `nama_bank`, `nomor_rekening`, `nama_pemilik`, `statusgm`) VALUES
(1, '1_1523329392.png', 'bankku', '12312', 'ABudur', 0),
(2, '', '', '', '', 0),
(3, '', '', '', '', 0),
(4, '', '', '', '', 0),
(5, '', '', '', '', 0),
...
INSERT INTO `login` (`id`, `email`, `password`, `nama`, `notelp`, `status`, `stat_log`) VALUES
(1, 'member@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'member saja', '085608129137', 2, 0),
(2, 'akuntan@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'akuntan pertama', '085608129137', 1, 1),
(3, 'abc@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Akuntan Tersetifikas', '085612391263', 1, 0),
(4, 'akuntanbaru@gmail.co', '81dc9bdb52d04dc20036dbd8313ed055', 'Akuntan Baru nih', '089123123', 1, 0),
(5, 'akuntanbaru@gmail.co', '81dc9bdb52d04dc20036dbd8313ed055', 'Akuntan Baru nih', '089123123', 1, 0),
(6, 'akuntanbaru@gmail.co', '81dc9bdb52d04dc20036dbd8313ed055', 'Akuntan Baru nih', '089123123', 1, 0),
(7, 'akuntanbaru@gmail.co', '81dc9bdb52d04dc20036dbd8313ed055', 'Akuntan Baru nih', '089123123', 1, 0),
(8, 'idangsaputra85@gmail', '26a59fcc390bf6170a59f2f55434a45a', 'Idang Raya Saputra', '081944946266', 1, 0),
(9, 'idangsaputra85@gmail', '26a59fcc390bf6170a59f2f55434a45a', 'Idang Raya Saputra', '081944946266', 1, 0),
(10, 'aab.peezz@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'abul', '123123', 2, 0),
(11, 'apemo@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'abdul', '1234', 1, 0);

--
-- Trigger `login`
--
DELIMITER $$
CREATE TRIGGER `insert_datadiri` AFTER INSERT ON `login` FOR EACH ROW begin
insert into data_diri(id_login) values(new.id);
insert into identitas(id_login) values(new.id);
end
$$
DELIMITER ;
...
--
-- Struktur dari tabel `pemesanan_akuntan`
--

CREATE TABLE `pemesanan_akuntan` (
  `id` int(11) NOT NULL,
  ...
  `tgl_com` datetime NOT NULL,
  `keterangan` text NOT NULL,
  `status` char(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `pemesanan_akuntan`
--

INSERT INTO `pemesanan_akuntan` (`id`, `idakuntan`, `idpemesan`, `idlayanan`, `harga`, `tgl_masuk`, `tgl_com`, `keterangan`, `status`) VALUES
(1, 2, 1, 2, 500000, '2018-04-11 06:30:12', '2018-04-11 08:06:37', '', 'terima'),
(2, 2, 1, 2, 500000, '2018-04-11 06:51:21', '0000-00-00 00:00:00', 'Begini dan Begitula mas, harus diginikan', '0'),
(3, 2, 1, 2, 500000, '2018-04-14 21:00:25', '0000-00-00 00:00:00', '', '');
...
--
-- Dumping data untuk tabel `tab_data`
--

INSERT INTO `tab_data` (`id`, `nama`) VALUES
(1, 'Data Diri'),
(2, 'Identitas'),
(3, 'Layanan'),
(4, 'Dompet'),
...
--
-- Struktur dari tabel `user_layanan`
--
...
--
-- Dumping data untuk tabel `user_layanan`
--

INSERT INTO `user_layanan` (`id_login`, `id_layanan`, `harga`) VALUES
(2, 2, 500000),
(2, 6, 750000);
...
--
-- Indeks untuk tabel `pemesanan_akuntan`
--
ALTER TABLE `pemesanan_akuntan`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `pemesanan_akuntan`
--
ALTER TABLE `pemesanan_akuntan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `tab_data`
--
ALTER TABLE `tab_data`
